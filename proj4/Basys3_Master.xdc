...
set_property PACKAGE_PIN W5 [get_ports fastclk]							
	...
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports fastclk]
...
set_property PACKAGE_PIN V7 [get_ports {Do}]							
	set_property IOSTANDARD LVCMOS33 [get_ports {Do}]

set_property PACKAGE_PIN U2 [get_ports {Ao[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Ao[0]}]
set_property PACKAGE_PIN U4 [get_ports {Ao[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Ao[1]}]
set_property PACKAGE_PIN V4 [get_ports {Ao[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Ao[2]}]
set_property PACKAGE_PIN W4 [get_ports {Ao[3]}]					
