...
#set_property PACKAGE_PIN E19 [get_ports ledT]					
	#set_property IOSTANDARD LVCMOS33 [get_ports ledT]
...
set_property PACKAGE_PIN V7 [get_ports {decimalPt}]							
	set_property IOSTANDARD LVCMOS33 [get_ports {decimalPt}]
